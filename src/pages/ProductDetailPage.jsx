...
//   (p) => p.id === model?.id || p.name === model?.name
// );
...
//                   4×4 Dante digital audio channels, it provides exceptional flexibility for small to mid-sized AV systems.
...
//                     name: "AuriControl+",
//                     description: `AuriControl+ is our dedicated configuration software, available for free download from our official website. 
//             Designed with a user-friendly interface, it allows users to easily tailor the matrix settings to match the specific needs 
//             of any installation. With this software, you can configure a wide range of parameters, including:`,
//                     parameters: [
//                         "Input Gain",
//                         "Expander",
//                         "Compressor & Limiter",
...
//             return {
//                 overview: `The Resoundify AurisPro-88D is a professional-grade 8x8 Digital Signal Processor (DSP) designed for highperformance audio applications in conferencing, commercial AV, and integrated systems. With native
//                             support for Dante™ audio networking, and built-in AEC (Acoustic Echo Cancellation) and ANC (Automatic
//                             Noise Cancellation) on all mic inputs, it ensures crystal-clear voice and audio transmission in even the most
//                             acoustically challenging environments.
//                             This versatile DSP features 8 balanced analog inputs and 8 balanced outputs, along with 8x8 Dante digital
//                             channels, enabling seamless integration with modern AV networks. The AurisPro-88D supports flexible
//                             routing, powerful DSP tools (EQ, dynamics, delay, etc.), and remote control via Ethernet or RS-232, making it
//                             an ideal solution for medium to large meeting rooms, boardrooms, lecture halls, and hybrid AV
//                             environments.
//                             `,
//                 keyFeatures: [
...
//             return {
//                 overview: `The Resoundify AurisPro-1616D is a flagship-grade 16x16 Advanced Audio Digital Signal Processor (DSP)
//                             designed for large-scale, mission-critical AV installations. Powered by the ADI SHARC DSP platform, it delivers
//                             robust performance, ultra-low latency, and professional-grade audio processing. With 16 balanced analog
...
//                             Ideal for enterprise-level applications, the AurisPro-1616D includes full-duplex AEC (Acoustic Echo
//                             Cancellation) and ANC (Automatic Noise Cancellation) on all mic inputs, ensuring crystal-clear
//                             communication in challenging acoustic environments. It also features intelligent auto mixing, feedback
//                             suppression, gain sharing, and ambient noise compensation—making it a complete solution for conferencing,
...
//             return {
//                 overview: `The Resoundify AurisPro-6464D is a high-performance, enterprise-class 64x64 Audio Digital Signal Processor (DSP) 
//                         engineered for large-scale, professional AV installations. Designed for audio environments that demand extensive input/output 
//                         capacity and uncompromising processing power, this DSP is built on the Analog Devices SHARC DSP platform and supports full 
//                         Dante™ audio networking (64x64 channels). With built-in AEC (Acoustic Echo Cancellation) and ANC (Automatic Noise Cancellation) 
//                         on all mic channels, the AurisPro-6464D guarantees crystal-clear voice pickup and reliable audio clarity in high-density 
//                         conferencing or broadcast setups. It features intelligent audio tools such as auto-mixing, adaptive feedback suppression, AGC, 
//                         ducking, and ambient noise compensation, all configurable through an intuitive interface.`,
...
//     model.description ||
//     "Professional audio solution designed for high-performance applications.",
...
//                         {/* Key Features */}
//                         <div className="bg-white rounded-lg border border-gray-200 p-6 max-h-[350px] flex flex-col">
//                             <h2 className="text-xl font-semibold text-gray-900 mb-4 sticky top-0 bg-white z-10 pb-1">
//                                 Key Features
//                             </h2>
//                             <ul className="space-y-2 overflow-y-auto pr-2" style={{ maxHeight: "280px" }}>
...
//                         {/* Applications */}
//                         <div className="bg-white rounded-lg border border-gray-200 p-6 max-h-[350px] flex flex-col">
//                             <h2 className="text-xl font-semibold text-gray-900 mb-4 sticky top-0 bg-white z-10 pb-2">
//                                 Applications
//                             </h2>
//                             <ul className="space-y-3 overflow-y-auto pr-2" style={{ maxHeight: "280px" }}>
...
//                                 {productData.controlSoftware.title}
//                             </h2>

//                             <p className="text-gray-700 mb-4">
//                                 <span className="font-semibold">{productData.controlSoftware.name}</span> —{" "}
//                                 {productData.controlSoftware.description}
//                             </p>
...
//                                             className={`py-4 text-md font-medium border-b-2 transition-colors ${activeSpecTab === index
